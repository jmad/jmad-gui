 ...
 * 
 * The Initial Developer of the Original Code is Olivier Dameron (dameron@smi.stanford.edu). Portions created by the
 * Initial Developer are Copyright (C) 2004 the Initial Developer. All Rights Reserved.
 * 
 * Contributor(s):
 * 
...
/**
 * Provides a PrintStream for writing on a ScriptConsole. Useful for redirecting System.out to the script console.
 * 
