...
public interface OrbitSegmentCalculator {
     ...
     * @return the mapping between [element, value mapping] for all elements defined in the segment for the plane
     *         defined by {@link #getPlane()}. where value mapping may contain orbit and angle
     */
    public abstract Map<Element, Map<MadxTwissVariable, Double>> calculate(Orbit orbit);
