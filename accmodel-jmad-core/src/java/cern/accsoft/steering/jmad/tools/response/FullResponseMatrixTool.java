...
public class FullResponseMatrixTool implements ResponseMatrixTool {
    ...
    public Matrix calcResponseMatrix(JMadModel model, ResponseRequest request) throws JMadModelException {
        ...
        for (int i = 0; i < correctorNames.size(); i++) {
            ...
            TfsResultImpl minus = calcResponse(model, corrector, correctorPlane, -strengthValue, monitorNames, request
                    .getMonitorRegexps());
            TfsResultImpl plus = calcResponse(model, corrector, correctorPlane, strengthValue, monitorNames, request
                    .getMonitorRegexps());
