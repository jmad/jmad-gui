 ...
 * 
 */
public class Ti8ModelDefinitionFactory implements ModelDefinitionFactory {

	@Override
	public JMadModelDefinition create() {
		JMadModelDefinitionImpl modelDefinition = new JMadModelDefinitionImpl();
		modelDefinition.setName("TI8");

		ModelPathOffsetsImpl offsets = new ModelPathOffsetsImpl();
		offsets.setResourceOffset("ti8/ti8");
		...
		OpticsDefinition opticsDefinition = new OpticsDefinitionImpl(
				"default optics", new ModelFile[] { new CallableModelFileImpl(
						"TI8.str", ModelFileLocation.RESOURCE,
						ParseType.STRENGTHS) });
...
//		range.addResponeElementNameRegexp("BTV.*");
		range.addPostUseFile(new CallableModelFileImpl("setb2b3.madx",
				ModelFileLocation.RESOURCE));
