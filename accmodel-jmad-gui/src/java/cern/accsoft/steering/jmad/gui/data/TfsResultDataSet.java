...
public class TfsResultDataSet extends AbstractDataSet implements MarkerXProvider {
    private final static Logger logger = Logger.getLogger(TfsResultDataSet.class);
    ...
    public TfsResultDataSet(String name, MadxVariable xVar, TwissVariable yVar, TfsResultDataSetType type,
            TfsResult tfsResult, TfsResult referenceTfsResult) {
        super(name);
        this.xVar = xVar;
        this.yVar = yVar;
        this.type = type;
                ...
                for (int i = 0; i < yVals.size(); i++) {
                    ...
                    if (refValue != null) {
                        if (TfsResultDataSetType.DIFFERENCE.equals(this.type)) {
                            value -= refValue;
                        } else if (TfsResultDataSetType.RELATIVE.equals(this.type)) {
                            value /= refValue;
                        } else if (TfsResultDataSetType.BEATING.equals(this.type)) {
     ...
     * 
     * @param tfsResult the Result to set
     */
     ...
     * 
     * @param referenceTfsResult the TfsResult to set as Reference
     */
