...
public class ModelDefCreator {
	...
	public final static void main(String[] args) {
		...
		ModelDefinitionFactory[] factories = new ModelDefinitionFactory[] { new LhcModelDefinitionFactory() };
		...
		for (ModelDefinitionFactory factory : factories) {
			...
			String fileName = ModelDefinitionUtil
			...
			System.out
					.println("Writing file '" + file.getAbsolutePath() + "'.");
			try {
